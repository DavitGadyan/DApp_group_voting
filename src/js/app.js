  ...
  render: function() {
    ...
    for (var i = 1; i <= candidatesCount; i++) {
      electionInstance.candidates(i).then(function(candidate) {
        ...
        var candidateTemplate = "<tr><th>" + id + "</th><td>" + name.replace('Candidate', 'Option') + "</td><td>" + voteCount + "</td></tr>"
        candidatesResults.append(candidateTemplate);

        // Render candidate ballot option
        var candidateOption = "<option value='" + id + "' >" + name.replace('Candidate', 'Option') + "</ option>"
